...
export default function QueueEngine({ data }) {
  ...
  // ── Condition badge: shows the live "X in Y?" membership check ──
  // e.g. "newWord in wordSet?" for BFS word-ladder style problems.
  ...
  return (
    <div className="relative flex flex-col items-center justify-center w-full h-full p-8 overflow-hidden bg-transparent">
      ...
      {/* Condition badge — top right, shows current membership/guard check */}
      {conditionBadge && (
