...
import { Network, Plus, ArrowRight, KeyRound, User, ArrowLeft } from "lucide-react";

const MotionDiv = motion.div;

const LobbyScreen = ({ isLightMode }) => {
  ...
  useEffect(() => {
    ...
    // Optional: Handle socket connection errors to reset loading state
      ...
      >
        ...
        >
          ...
          <div className="flex flex-col items-center text-center mb-8">
            ...
            >
              Join the real-time collaboration space
            </p>
          </div>
